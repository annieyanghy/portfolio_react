      ...
      <div className="flex flex-col justify-content mb-20">
        ...
        <div id="Understand" className="flex flex-col relative mt-10 pt-10 w-full items-center justify-center  bg-indigo-500">
          ...
          {/* <MainImg imgPath="/cabbage/Focus_User journey.png" title="User journey" 
                  description=""/> */}
          <div className="relative my-10  md:w-8/12 justify-center rounded-3xl bg-indigo-900">
          ...
          <div className="relative my-10 py-8 px-14 md:w-8/12 justify-center rounded-3xl bg-indigo-900">
          ...
          <div className="relative my-10 py-8 px-14  md:w-8/12 justify-center rounded-3xl bg-fuchsia-700">
            <div className=" w-full max-w-5xl justify-items-center mx-auto">
        ...
        <div id="Design" className="flex flex-col relative mt-10 w-full items-center justify-center  ">
          ...
          <div className="relative my-10 py-8   md:w-8/12 justify-center rounded-3xl bg-slate-800/50">
          ...
          <div className="relative my-10 py-8  md:w-8/12 justify-center rounded-3xl bg-slate-950/50">
